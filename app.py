...
def profile():
    ...
    if form.validate_on_submit() and form.profile_pic.data:
        ...
        if old_rel:
            ...
            # evitar borrar fuera del directorio de uploads y no borrar default
        ...
        # Carpeta física (en disco) -> usa join “normal”
        upload_folder = os.path.join(app.root_path, app.config['UPLOAD_FOLDER'], 'profile_pics')  # abs path
